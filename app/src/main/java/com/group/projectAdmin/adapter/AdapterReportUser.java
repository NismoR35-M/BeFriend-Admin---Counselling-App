...
public class AdapterReportUser extends RecyclerView.Adapter<AdapterReportUser.MyHolder>{
    ...
    public AdapterReportUser(Context context, List<UserModel> createModels) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(view -> {
            String[] colors = {"Send warning", "Delete user", "View profile","Remove from report"};
            ...
            builder.setItems(colors, (dialog, which) -> {
                if (which == 1){
                    ...
                    FirebaseDatabase.getInstance().getReference().child("Report").child(createModels.get(position).getId()).getRef().removeValue();
