...
import com.group.projectAdmin.adapter.AdapterReportUser;
...
public class ReportUserListActivity extends AppCompatActivity {

    //User
    String id;
    private RecyclerView users_rv;
    private List<UserModel> userList;
    private AdapterReportUser adapterUsers;
    List<String> idList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        users_rv.setLayoutManager(new LinearLayoutManager(ReportUserListActivity.this));
    ...
    private void filter(String query) {
        FirebaseFirestore.getInstance().collection("users").addSnapshotListener((value, error) -> {
            ...
            for (DocumentSnapshot ds : Objects.requireNonNull(value)){
                ...
                adapterUsers = new AdapterReportUser(ReportUserListActivity.this, userList);
